...
import 'package:carigari/screens/products.dart';
...
class ProductItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(child:ListTile(
                      ...
                      subtitle: Text("Price Starts from ₹ ${product.price}"),
                      // dense: true,
                      onTap: (){
                        // Navigator.pushNamed(context,"ContactUs");
                        Navigator.pushNamed(context, "ProductDetailScreen", arguments: product.id,);
                        // SubCategory(index);
